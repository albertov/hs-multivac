...
#ifndef FILE_SAVER_NEVERSAVE_CXX


#include "neversave.hxx"
...
namespace Multivac
{
  ...
  */
  template <class T>
  CNeverSave<T>::
  CNeverSave(string TimeFileName, string CurvesFileName,
  ...
  */
  template <class T>
  void CNeverSave<T>::SaveAtTheBeginning(CMesh<T>& Mesh,
					 CSpeedFunction<T>& F,
					 CLevelSet<T>& Phi,
  ...
  */
  template <class T>
  void CNeverSave<T>::SaveAtCurrentIteration(CMesh<T>& Mesh,
					     CSpeedFunction<T>& F,
					     CLevelSet<T>& Phi,
					     T time, int iter,
					     CInitializer<T>& Initializer)
  ...
  */
  template <class T>
  void CNeverSave<T>::SaveAtTheEnd(CMesh<T>& Mesh,
				   CSpeedFunction<T>& F,
				   CLevelSet<T>& Phi,
				   Vector<T>& Time,
				   int iter,
...
#define FILE_SAVER_NEVERSAVE_CXX
#endif
