...
#ifndef FILE_SAVER_SAVEATTHEEND_CXX


#include "saveattheend.hxx"
...
namespace Multivac
{
  ...
  //! Default constructor.
  template <class T>
  CSaveAtTheEnd<T>::CSaveAtTheEnd()  throw()
  {
  ...
  */
  template <class T>
  void CSaveAtTheEnd<T>::SaveAtTheBeginning(CMesh<T>& Mesh,
					    CSpeedFunction<T>& F,
					    CLevelSet<T>& Phi,
  ...
  */
  template <class T>
  void CSaveAtTheEnd<T>::SaveAtCurrentIteration(CMesh<T>& Mesh,
						CSpeedFunction<T>& F,
						CLevelSet<T>& Phi,
						T time, int iter,
						CInitializer<T>& Initializer)
  ...
  //! Saves the last mesh, the last speed function and the last
  //! level set function.
  /*! \param Mesh initial mesh.
    \param F initial speed function.
    \param Phi initial level set.
  ...
  */
  template <class T>
  void CSaveAtTheEnd<T>::SaveAtTheEnd(CMesh<T>& Mesh,
				      CSpeedFunction<T>& F,
				      CLevelSet<T>& Phi,
				      Vector<T>& Time,
				      int iter,
...
#define FILE_SAVER_SAVEATTHEEND_CXX
#endif
