...
#ifndef FILE_UPDATER_NARROWBANDFIRSTORDERLAXFRIEDRICHS_HXX
...
namespace Multivac
{
  ...
  ////////////////////////////////////////
  // CNARROWBANDFIRSTORDERLAXFRIEDRICHS //
  ////////////////////////////////////////

  //! This updater uses the first order Lax-Friedrichs scheme.
   ...
   */
  template <class T>
  class CNarrowBandFirstOrderLaxFriedrichs: public CUpdater<T>
  {
...
#define FILE_UPDATER_NARROWBANDFIRSTORDERLAXFRIEDRICHS_HXX
#endif
