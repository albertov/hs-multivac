...
int main()
{
  ...
  typedef CConstantSpeed<real> SpeedType;
  ...
  string InitialFrontFile = "M.pts";
  // Is the (Xmin, Ymin) outside the front?
  bool origin_out = true;
  ...
  typedef CFastMarchingNeverInit<real> InitializerType;
  ...
  //         * Narrow band level set method
  //        ** Fast marching method
  typedef CFastMarchingFirstOrderEngquistOsher<real> UpdaterType;
  ...
  typedef CSaveAtTheEnd<real> SaverType;
